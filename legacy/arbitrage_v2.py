...
class FastArbitrageScanner:
    ...
    async def check_single_market(self, market: dict) -> ArbitrageOpp | None:
        ...
        exec_time = (datetime.now(UTC) - start).total_seconds() * 1000
...
class ArbitrageSimulatorV2:
    def __init__(self, capital: float = 100.0, min_margin: float = 0.02):
        ...
        self.min_margin = min_margin
        self.scanner: FastArbitrageScanner | None = None
