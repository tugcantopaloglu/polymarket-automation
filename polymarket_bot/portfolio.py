...
from .client import PolymarketClient, MarketInfo, Position
from .data.database import db
from .analysis.market_analyzer import market_analyzer, RiskMetrics
...
class PortfolioManager:
    ...
    def get_position(self, token_id: str) -> Optional[PortfolioPosition]:
