...
from .utils.rate_limiter import RateLimiter, retry_with_backoff, RetryConfig, RetryableError, CircuitBreaker
...
class PolymarketClient:
    ...
    async def get_order_books_batch(self, token_ids: list[str]) -> dict[str, OrderBook]:
        ...
        return {
            tid: result for tid, result in zip(token_ids, results)
